...
<body style="background-color: #D2C7BA;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td align="center" bgcolor="#D2C7BA">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 0px 36px 24px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or
                                concerns about your order, please <a href="tel:+15301234567">contact us</a>.</p><br>
        ...
        `
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 0px 24px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
